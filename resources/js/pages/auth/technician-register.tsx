...
export default function TechnicianRegisterPage() {
    ...
    const onSubmit = async (e: React.FormEvent) => {
        ...
        setError(null)
        try {
            await axios.post('/auth/technician/register', { 
    ...
    return (
        <>
            ...
            <AuthLayout
                ...
                description="Sign up as a technician to offer repair services"
                sideImageSrc="/images/chooserolepic.jpg"
            >
                    <Head title="Technician Register" />
                    <form onSubmit={onSubmit} className="space-y-4">
                        ...
                        <div>
                            <Input value={expertise} onChange={e=>setExpertise(e.target.value)} placeholder="Specialization" required maxLength={100} />
                        </div>
                        <div>
